...
<main>
    <header class="masthead" style="background-image: url('<?php echo htmlspecialchars($restaurant['image_url']); ?>')">
    ...
    <!-- Navigation -->
    <nav class="section-navigation" style="color: white;">
        <ul>
    ...
    <section class="main" style="color: white;">
        ...
        <!-- Food/Costs Section -->
        <section id="food-costs" class="section">
            <h2>Food/Costs</h2>
            <div class="red-line"></div>
        ...
        <section id="reservation" class="section">
            ...
            <div class="reservation-container">
                ...
                <figure>
                    <img src="/images/reservation.png" alt="Reservation illustration" class="reservation-image" />
                </figure>
            </div>
        </section>
