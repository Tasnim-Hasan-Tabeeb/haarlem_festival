...
<?php foreach ($sections as $section) : ?>
    <?php if ($section->getSectionType() === 'header') : ?>
        <div class="restaurants-header-section">
            ...
            <div class="restaurants-header-image-wrap">
                <img src="<?= $section->getImageUrl() ?>" class="restaurants-header-image" />
            </div>
        </div>
    <?php endif; ?>
                    ...
                    <div class="restaurant-card-body">
                        ...
                        <div class="restaurant-features">
                            <?php foreach ($restaurant['features'] as $feature) : ?>
                                <div class="restaurant-feature-item">
                                    <img src="<?= $feature['image_url'] ?>" width="25" height="25" class="restaurant-feature-image" />
                        ...
                        <div class="restaurant-card-info">
                            <p class="restaurant-card-info-text">
                                <img src="/images/location-marker.png" class="restaurant-card-icon" />
                                <?= htmlspecialchars($restaurant['location']); ?>
                            </p>

                            <p class="restaurant-card-info-text">
                                <img src="/images/telephone.png" class="restaurant-card-icon" />
