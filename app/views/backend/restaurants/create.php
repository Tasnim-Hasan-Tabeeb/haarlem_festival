    ...
    <div class="mt-4">
        <form action="/restaurant/store" method="POST" autocomplete="off" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input min="0" type="number" step="any" class="form-control" id="price_for_children" name="price_for_child" required>
            </div>

            <div class="mb-3">
                <label for="price_for_adults" class="form-label">Price for adults</label>
                <input min="0" type="number" step="any" class="form-control" id="price_for_adults" name="price_for_adult" required>
            </div>
