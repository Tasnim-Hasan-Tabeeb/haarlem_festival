            ...
            <table class="table table-striped table-hover">
                ...
                <?php foreach ($tours as $tour) : ?>
                    <tr>
                        ...
                        <td>
<a href="/historytour/edit?id=<?= $tour['tour_id'] ?>" class="btn btn-primary btn-sm">Edit</a>                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $tour['tour_id'] ?>">Delete</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/historytour/delete?id=<?= $tour['tour_id'] ?>" class="btn btn-danger">Delete</a>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </td>
