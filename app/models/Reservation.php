...
{
    private mixed $reservation_id;
    private mixed $name = null;
    private mixed $reservation_date;
    private mixed $total_adult;
    private mixed $total_children;
    private mixed $email = null;
    private mixed $phone;
    private mixed $user_id = null;
    private mixed $session_id;
    private mixed $restaurant_id;
    private mixed $remarks;
    private mixed $cost_per_person;
    private mixed $is_active;
    private mixed $created_at = null;
    private mixed $updated_at = null;

    private mixed $restaurant_name = null;
    private mixed $total_cost;
    private mixed $payment_status;
    private mixed $confirmation_code;
